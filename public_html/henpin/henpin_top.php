          ...
          <div id="contents">
            ...
            <table border="0" width="550" cellpadding="0" cellspacing="0" class="tb_1">
              <tr height="60">
                ...
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_RETURN_RETIRE) ? print($APPLI_REASON_RETURN_RETIRE) : print('&#123;APPLI_REASON_RETURN_RETIRE&#125;'); ?>'; document.selectForm.submit(); return false;">[退職・異動返却]</a></td>
                
                <td class="line" width="350">職員の退職・異動による返却の場合、<br>選択して下さい。</td>
              </tr>
<?php if($isLevelItc) { ?>
              <tr height="60">
                
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_RETURN_OTHER) ? print($APPLI_REASON_RETURN_OTHER) : print('&#123;APPLI_REASON_RETURN_OTHER&#125;'); ?>'; document.selectForm.submit(); return false;">[その他返却]</a></td>
                
                <td class="line" width="350">退職・異動以外の下記のような返却<br>例1)特寸作成中の代替商品の返却<br>例2)誤発注の商品の返却</td>
              </tr>
<?php } ?>
            </table>
          </div>
