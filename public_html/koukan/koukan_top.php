...
<?php } ?>
        ...
        <form method="post" action="../select_staff.php" name="selectForm">
          <div id="contents">
            <h1>ユニフォーム交換方法選択</h1>
            <table border="0" width="550" cellpadding="0" cellspacing="0" class="tb_1">
              <tr height="60">
                
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_EXCHANGE_FIRST) ? print($APPLI_REASON_EXCHANGE_FIRST) : print('&#123;APPLI_REASON_EXCHANGE_FIRST&#125;'); ?>'; document.selectForm.submit(); return false;">[初回サイズ交換]</a></td>
                
                <td class="line" width="350">最初の発注分で商品のサイズが合わない場合はこちらを選択して下さい。<br></td>
              </tr>
              <tr height="60">
                
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_EXCHANGE_SIZE) ? print($APPLI_REASON_EXCHANGE_SIZE) : print('&#123;APPLI_REASON_EXCHANGE_SIZE&#125;'); ?>'; document.selectForm.submit(); return false;">[サイズ交換]</a></td>
                
                <td class="line" width="350">着用中の商品のサイズが合わない場合、選択して下さい。<br></td>
              </tr>
              <tr height="60">
                
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_EXCHANGE_BREAK) ? print($APPLI_REASON_EXCHANGE_BREAK) : print('&#123;APPLI_REASON_EXCHANGE_BREAK&#125;'); ?>'; document.selectForm.submit(); return false;">[汚損・破損交換]</a></td>
                
                <td class="line" width="350">着用中の商品に洗濯で落ちない汚れが付着したり、破れたりした場合の商品交換時に選択して下さい。</td>
              </tr>
              <tr height="60">
                
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_EXCHANGE_LOSS) ? print($APPLI_REASON_EXCHANGE_LOSS) : print('&#123;APPLI_REASON_EXCHANGE_LOSS&#125;'); ?>'; document.selectForm.submit(); return false;">[紛失交換]</a></td>
                
                <td class="line" width="350">着用中の商品を紛失した場合の代替商品発注時に選択して下さい。</td>
              </tr>
              <tr height="100">
                <td colspan="2">
                  <font color="red">
                    ※サイズ交換には経費がかかります。<br>
                    ※不良品は株式会社ユニコ　SOMPOケアフーズ様担当係へ直接ご連絡下さい。<br>　（ご連絡先はマニュアルを参照下さい）
                  </font>
                </td>
              </tr>
            </table>
