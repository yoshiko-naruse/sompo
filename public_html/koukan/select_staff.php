...
<?php for ($i1_staff=0; $i1_staff<count($staff); $i1_staff++) { ?>
              <tr height="30">
                ...
                <td class="line2" align="center">
                  ...
                  <input type="button" value="交換" onclick="document.selectForm.action='./koukan_shinsei.php'; document.selectForm.staffId.value='<?php isset($staff[$i1_staff]['StaffID']) ? print($staff[$i1_staff]['StaffID']) : print('&#123;staff.StaffID&#125;'); ?>'; document.selectForm.submit(); return false;">
