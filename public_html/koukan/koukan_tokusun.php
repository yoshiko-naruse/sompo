...
<?php } ?>
          ...
          <br>
          <h3>◆ヌード寸法を入力して下さい。</h3>
          <form action="./koukan_shinsei_kakunin.php" name="confForm" method="post">
