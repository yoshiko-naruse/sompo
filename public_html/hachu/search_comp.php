...
<html>
  <head>
    ...
    <!--
    function setComp(zip1, zip2, address, tel, shipName, staffName) {

      if(!window.opener || window.opener.closed){
        window.close(); 
      } 

      window.opener.document.registForm.zip1.value = zip1;
      window.opener.document.registForm.zip2.value = zip2;
      window.opener.document.registForm.address.value = address;
      window.opener.document.registForm.tel.value = tel;
      window.opener.document.registForm.shipName.value = shipName;
      window.opener.document.registForm.staffName.value = staffName;
      window.close();
      return false;
  ...
  <body>
    <div id="main3">
      ...
      <form method="post" action="./search_comp.php" name="pagingForm" onkeydown="javascript:return funcformonkeydown();">
        <div id="contents">
          <p class="fbold tb_1" style="margin-top:0px; font-size:120%">施設検索</p>
          <table border="0" width="400" cellpadding="0" cellspacing="0" class="tb_1">
            ...
            <tr>
              ...
              <td width="30" class="line"><input name="shop_btn" type="button" value="　検索　" onclick="document.pagingForm.searchFlg.value='1'; document.pagingForm.submit(); return false;"></td>
            </tr>
          </table>
<?php if($isSearched) { ?>
...
<?php for ($i1_comps=0; $i1_comps<count($comps); $i1_comps++) { ?>
            <tr height="20">
              <td class="line2" align="center"><a href="#" onclick="setComp('<?php isset($comps[$i1_comps]['Zip1']) ? print($comps[$i1_comps]['Zip1']) : print('&#123;comps.Zip1&#125;'); ?>', '<?php isset($comps[$i1_comps]['Zip2']) ? print($comps[$i1_comps]['Zip2']) : print('&#123;comps.Zip2&#125;'); ?>', '<?php isset($comps[$i1_comps]['Adrr']) ? print($comps[$i1_comps]['Adrr']) : print('&#123;comps.Adrr&#125;'); ?>', '<?php isset($comps[$i1_comps]['Tel']) ? print($comps[$i1_comps]['Tel']) : print('&#123;comps.Tel&#125;'); ?>', '<?php isset($comps[$i1_comps]['ShipName']) ? print($comps[$i1_comps]['ShipName']) : print('&#123;comps.ShipName&#125;'); ?>', '<?php isset($comps[$i1_comps]['TantoName']) ? print($comps[$i1_comps]['TantoName']) : print('&#123;comps.TantoName&#125;'); ?>');"><?php isset($comps[$i1_comps]['CompCd']) ? print($comps[$i1_comps]['CompCd']) : print('&#123;comps.CompCd&#125;'); ?></a></td>
