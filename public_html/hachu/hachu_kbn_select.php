...
<?php } ?>
        ...
        <h1>パターン選択</h1>
        <br>
        <form action="./hachu_top.php" name="topForm" method="post">
          <table border="0" cellpadding="0" cellspacing="0">
            <tr height="80">
              <td class="line" width="200" align="center"><a href="#" onclick="document.topForm.appliReason.value='<?php isset($APPLI_REASON_ORDER_JOB1) ? print($APPLI_REASON_ORDER_JOB1) : print('&#123;APPLI_REASON_ORDER_JOB1&#125;'); ?>'; document.topForm.submit(); return false;"><img src="../img/bt_default.gif" alt="基本パターン" width="120" height="35" border="0"></a></td>
              <td class="line" width="400" align="left">
                  通常基本パターンの発注は、こちらから発注して下さい。
              </td>
            </tr>
            <tr height="80">
              <td class="line" width="200" align="center"><a href="#" onclick="document.topForm.appliReason.value='<?php isset($APPLI_REASON_ORDER_PERSONAL) ? print($APPLI_REASON_ORDER_PERSONAL) : print('&#123;APPLI_REASON_ORDER_PERSONAL&#125;'); ?>'; document.topForm.submit(); return false;"><img src="../img/bt_kobetsu_hachu.gif" alt="個別発注申請" width="120" height="35" border="0"></a></td>
              <td class="line" width="400" align="left">
                  部署異動に伴う貸与枚数不足等、イレギュラーの発注の際は、こちらから発注して下さい。
              </td>
            </tr>

          </table>
          <input type="hidden" name="appliReason">
          <input type="hidden" name="staffId" value="<?php isset($searchStaffId) ? print($searchStaffId) : print('&#123;searchStaffId&#125;'); ?>" >
        </form>
