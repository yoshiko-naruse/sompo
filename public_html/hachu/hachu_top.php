...
<?php if($isLevelNormal) { ?>
              <tr height="60">
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_ORDER_BASE) ? print($APPLI_REASON_ORDER_BASE) : print('&#123;APPLI_REASON_ORDER_BASE&#125;'); ?>'; document.selectForm.submit(); return false;">[基本セット]</a></td>
                <td class="line" width="350">そんぽの家系：そんぽの家・S、SOMPOケアデイサービス<br>ラヴィーレ系：ラヴィーレ・レジデンス、ハッピーデイズ、そんぽの家S湘南台</td>
              </tr>
<?php if($isHoteruLikeUser) { ?>
              <tr height="60">
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_ORDER_GRADEUP) ? print($APPLI_REASON_ORDER_GRADEUP) : print('&#123;APPLI_REASON_ORDER_GRADEUP&#125;'); ?>'; document.selectForm.submit(); return false;">[グレードアップタイ]</a></td>
                <td class="line" width="350">グレードアップタイの貸与は、こちらから発注して下さい。</td>
              </tr>
<?php } ?>
<?php } ?>
<?php if(!$isLevelNormal) { ?>
...
<?php if($isLevelItc) { ?>
              <tr height="60">
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_ORDER_FRESHMAN) ? print($APPLI_REASON_ORDER_FRESHMAN) : print('&#123;APPLI_REASON_ORDER_FRESHMAN&#125;'); ?>'; document.selectForm.submit(); return false;">[新入社員]</a></td>
                <td class="line" width="350">新入社員への新品貸与は、こちらから発注して下さい。</td>
              </tr>
              <tr height="60">
                <td class="line" width="200"><a href="#" onclick="document.selectForm.appliReason.value='<?php isset($APPLI_REASON_ORDER_PERSONAL) ? print($APPLI_REASON_ORDER_PERSONAL) : print('&#123;APPLI_REASON_ORDER_PERSONAL&#125;'); ?>'; document.selectForm.submit(); return false;">[個別発注申請]</a></td>
                <td class="line" width="350">イレギュラーの発注の際は、こちらから発注して下さい。</td>
              </tr>
<?php } ?>
<?php } ?>
            </table>
