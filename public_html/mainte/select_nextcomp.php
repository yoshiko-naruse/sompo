...
<html>
  <head>
    ...
    function setComp(compCd, compName, compId) {
      ...
      window.opener.document.pagingForm.selectNextCompId.value = compId;
      window.opener.document.pagingForm.selectNextCompCd.value = compCd;
      window.opener.document.pagingForm.selectNextCompName.value = compName;
      window.close();
      return false;
  ...
  <body>
    <div id="main3">
      ...
      <form method="post" action="./select_nextcomp.php" name="pagingForm" onkeydown="javascript:return funcformonkeydown();">
        <div id="contents">
