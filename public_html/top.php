...
<?php } ?>
        ...
        <div id="contents">
          ...
          <table border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="700">
                <div align="right"><a href="change_password.php">[ログインパスワードの変更]</a></div>
              </td>
            </tr>
          </table>
          <br>
          ...
          <br>
          <div align="center">
            <span style="font-size:16px;"><b>制服管理システム</b></span>
            <br><br>
          </div>
              ...
              <tr>
                <td width="620" align="left">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" align="center">
                    <tr>
                      <td colspan="2">■新規発注方法</td>
                    </tr>
                    <tr>
                      <td width="50">&nbsp;</td>
                      <td width="450">１．管理機能＞職員マスタメンテ＞新規登録</td>
                    </tr>
                    <tr>
                      <td width="50">&nbsp;</td>
                      <td width="450">２．発注</td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="2">■サイズ交換お問い合わせ先</td>
                    </tr>
                    <tr>
                      <td width="50">&nbsp;</td>
                      <td width="450">ＳＯＭＰＯケアフーズ　小林様　携帯電話：080-7012-4282</td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="2">■上記以外のお問い合わせ</td>
                    </tr>
                    <tr>
                      <td width="50">&nbsp;</td>
                      <td width="450">株式会社ユニコ　窓口　　電話：03‐5643-2825</td>
                    </tr>
                </td>
              </tr>
            </table>
