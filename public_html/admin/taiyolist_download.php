  ...
  <head>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        $("#datepicker1").datepicker("setDate", "<?php isset($inputDay) ? print($inputDay) : print('&#123;inputDay&#125;'); ?>");
      });
    </script>
  </head>
  <body>
...
<?php } ?>
        ...
        <form method="post" action="./taiyolist_download.php" name="pagingForm">
          <div id="contents">
            <h1>貸与一覧表ダウンロード</h1>
            <table border="0" width="700" cellpadding="0" cellspacing="0" class="tb_1">
              <tr height="40">
                <td width="100" class="line"><font class="fbold">集計日指定</font></td>
                <td width="450" class="line"><input name="inputDay" type="text" value="<?php isset($inputDay) ? print($inputDay) : print('&#123;inputDay&#125;'); ?>" style="width:100px;" maxlength="10" id="datepicker1"></td>
                <td width="150" class="line" align="center">
                  <input type="button" value="貸与一覧表出力" onclick="document.pagingForm.action='./taiyolist_excel_dl.php'; document.pagingForm.submit(); document.pagingForm.action='./taiyolist_download.php'; return false;">
                </td>
              </tr>
            </table>
            <br>
