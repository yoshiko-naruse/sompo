...
//var_dump($post);
$inputFromDay = trim($post['inputFromDay']);	// 集計開始日
$inputToDay = trim($post['inputToDay']);		// 集計終了日
  ...
  <head>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        $("#datepicker1").datepicker("setDate", "<?php isset($inputFromDay) ? print($inputFromDay) : print('&#123;inputFromDay&#125;'); ?>");
        $("#datepicker2").datepicker();
        $('#datepicker2').datepicker("option", "dateFormat", 'yy/mm/dd' );
        $("#datepicker2").datepicker("setDate", "<?php isset($inputToDay) ? print($inputToDay) : print('&#123;inputToDay&#125;'); ?>");
      });
    </script>
  </head>
  <body>
...
<?php } ?>
        ...
        <form method="post" action="./seikyumeisai_download.php" name="pagingForm">
          <div id="contents">
            <h1>請求明細ダウンロード</h1>
            <table border="0" width="700" cellpadding="0" cellspacing="0" class="tb_1">
              <tr height="40">
                <td width="100" class="line"><font class="fbold">集計開始日</font></td>
                <td width="175" class="line"><input name="inputFromDay" type="text" value="<?php isset($inputFromDay) ? print($inputFromDay) : print('&#123;inputFromDay&#125;'); ?>" style="width:100px;" maxlength="10" id="datepicker1"></td>
                <td width="100" class="line"><font class="fbold">集計終了日</font></td>
                <td width="175" class="line"><input name="inputToDay" type="text" value="<?php isset($inputToDay) ? print($inputToDay) : print('&#123;inputToDay&#125;'); ?>" style="width:100px;" maxlength="10" id="datepicker2"></td>
                <td width="150" class="line" align="center">
                  <input type="button" value="請求明細出力" onclick="document.pagingForm.action='./seikyumeisai_excel_dl.php'; document.pagingForm.submit(); document.pagingForm.action='./seikyumeisai_download.php'; return false;">
                </td>
              </tr>
            </table>
            <br>
            <div class="bot"><a href="#" onclick="document.pagingForm.action='./admin_select.php'; document.pagingForm.submit(); return false;"><img src="../img/modoru.gif" alt="戻る" width="112" height="32" border="0"></a></div>
          </div>
