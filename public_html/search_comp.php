...
<html>
  <head>
    ...
    function setComp(compCd, compName, compId) {
      ...
      window.opener.document.pagingForm.searchCompId.value = compId;
      window.opener.document.pagingForm.searchCompCd.value = compCd;
      window.opener.document.pagingForm.searchCompName.value = compName;
      window.close();
      return false;
