...
<?php if($isAgree) { ?>
      if (confirm('承認を取り消してもよろしいですか')) {
        document.confForm.submit();
      }
<?php } ?>
<?php if(!$isAgree) { ?>
      if (confirm('否認を取り消してもよろしいですか')) {
        document.confForm.submit();
      }
<?php } ?>
...
<?php if($isReturn) { ?>
          ...
          <table border="0" width="700" cellpadding="0" cellspacing="0" class="tb_1">
            ...
            <tr height="30">
              <td class="line"><span class="fbold">事業所</span></td>
            ...
            <tr height="30">
              ...
              <td width="120" class="line"><?php isset($staffCode) ? print($staffCode) : print('&#123;staffCode&#125;'); ?></td>
              <td width="80" class="line"><span class="fbold">着用者氏名</span></td>
...
<?php } ?>
          <table border="0" width="700" cellpadding="0" cellspacing="0" class="tb_1">
            ...
            <tr height="30">
              <td class="line"><span class="fbold">施設</span></td>
              <td colspan="3" class="line"><?php isset($compCd) ? print($compCd) : print('&#123;compCd&#125;'); ?>：<?php isset($compName) ? print($compName) : print('&#123;compName&#125;'); ?></td>
            </tr>
            <tr height="30">
              <td class="line"><span class="fbold">職員コード</span></td>
            ...
            <tr height="25">
              ...
              <td>〒<?php isset($zip1) ? print($zip1) : print('&#123;zip1&#125;'); ?>-<?php isset($zip2) ? print($zip2) : print('&#123;zip2&#125;'); ?></td>
              <td colspan="2"><?php isset($address) ? print($address) : print('&#123;address&#125;'); ?></td>
            </tr>
          </table>
          <table border="0" width="700" cellpadding="0" cellspacing="0" class="tb_1">
            <tr height="25">
              <td width="100">&nbsp;</td>
              <td width="120"<span class="fbold">出荷先名</span></td> 
              <td width="480" colspan="5"><?php isset($shipName) ? print($shipName) : print('&#123;shipName&#125;'); ?></td>
            </tr>
            <tr height="25">
              <td width="100">&nbsp;</td>
              <td width="120"<span class="fbold">ご担当者</span></td>
              <td width="480" colspan="5"><?php isset($staffName) ? print($staffName) : print('&#123;staffName&#125;'); ?></td>
            </tr>
            <tr height="25">
              <td width="100" class="line">&nbsp;</td>
              <td width="120" class="line"><span class="fbold">電話番号</span></td>
              <td width="480" colspan="5" class="line"><?php isset($tel) ? print($tel) : print('&#123;tel&#125;'); ?></td>
            </tr>
<?php if(!$isOrder) { ?>
            <tr height="25">
...
<?php } ?>
          <form action="syounin_cancel_kanryo.php" name="confForm" method="post">
            <div class="bot">
              <table width="330" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="180">
<?php if($isAgree) { ?>
                    <span style="color:red">承認をキャンセルする場合は<br>キャンセルボタンを押して下さい</span><br>
<?php } ?>
<?php if(!$isAgree) { ?>
                    
                    <span style="color:red">否認をキャンセルする場合は<br>キャンセルボタンを押して下さい</span><br>
...
<?php } ?>
                ...
                <tr>
                  <td>
                    ...
                    <a href="#" onclick="document.confForm.action='./syounin.php'; document.confForm.submit(); return false;"><img src="../img/modoru.gif" alt="戻る" width="112" height="32" border="0"></a>
            ...
            <input type="hidden" value="1" name="confFlg">
