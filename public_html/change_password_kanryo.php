...
/* ../include/createPasswordMail.php start */
...
/* ../include/createPasswordMail.php end */
...
<?php } ?>
        ...
        <div id="contents">
          ...
          <table border="0" width="700" cellpadding="0" cellspacing="0" class="tb_1">
            ...
            <tr>
              <td>
                <div class="bot" align="center"><a href="./top.php">[トップ画面へ戻る]</a></div>
              </td>
            </tr>
          </table>
          <br>
